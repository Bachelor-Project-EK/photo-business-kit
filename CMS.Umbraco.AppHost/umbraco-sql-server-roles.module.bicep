...
param umbraco_sql_server_outputs_name string

param umbraco_sql_server_outputs_sqlserveradminname string
...
resource umbraco_sql_server 'Microsoft.Sql/servers@2023-08-01' existing = {
  name: umbraco_sql_server_outputs_name
}

resource sqlServerAdmin 'Microsoft.ManagedIdentity/userAssignedIdentities@2024-11-30' existing = {
  name: umbraco_sql_server_outputs_sqlserveradminname
}
...
resource script_umbraco_sql_server_UmbracoDb 'Microsoft.Resources/deploymentScripts@2023-08-01' = {
  name: take('script-${uniqueString('umbraco_sql_server', principalName, 'UmbracoDb', resourceGroup().id)}', 24)
  location: location
  identity: {
    type: 'UserAssigned'
  ...
  properties: {
    ...
    environmentVariables: [
      ...
      {
        name: 'DBSERVER'
        value: umbraco_sql_server.properties.fullyQualifiedDomainName
      }
      {
        name: 'PRINCIPALTYPE'
        value: principalType
